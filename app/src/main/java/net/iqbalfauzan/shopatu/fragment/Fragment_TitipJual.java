...
public class Fragment_TitipJual extends Fragment {
    public Fragment_TitipJual() {
    }
    Api mApi;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_titipjual, container, false);
        ...
        getListProdukTitipJual();
        return view;
    }
    private void getListProdukTitipJual(){
        mApi.getListProdukTitipJual("db969f0c56297c6bd3585785f1772789", "iqbalmf68@gmail.com").enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()){
                    try {
                        showListProdukTitipJual(response.body().string());
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }else {
    ...
    private void showListProdukTitipJual(String json){
        try {
