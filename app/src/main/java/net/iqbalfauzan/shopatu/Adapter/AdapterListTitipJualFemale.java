...
public class AdapterListTitipJualFemale extends RecyclerView.Adapter<AdapterListTitipJualFemale.Holder> {
    private Context context;
    private List<ModelTitipJual> modelTitipJuals;

    public AdapterListTitipJualFemale(Context context, List<ModelTitipJual> modelTitipJuals) {
